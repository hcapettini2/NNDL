...
#     ### Training function
#     def train_epoch(self,encoder, decoder,fc_mn,fc_std, device,dataloader, optimizer,verbose =True):
#         """
#         This function train the network for one epoch
#         """
...
#     ### Testing function
#     def test_epoch(self,encoder, decoder,fc_mn,fc_std, device, dataloader, verbose = True):
#         """
#         This function test the network performance for one epoch of training
#         """
...
#     def training_cycle(self,encoder,decoder,fc_mn,fc_std,device,training_data, test_data, optim,num_epochs,test_dataset, verbose = True):
#         """
#         This function train the network for a desired number of epochs it also test the network 
#         reconstruction performance and make plots comparing the input image and the reconstructed one every 5 epochs.
#         """
